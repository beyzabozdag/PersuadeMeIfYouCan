...
ranking_old_ER = """After each message you send, you should also self-rank your support for the claim on a Likert scale from 1 to 5, with 1: Completely Oppose, 2: Oppose, 3: Neutral, 4: Support, 5: Completely Support. This information will not be shared with the other agent. Only use integers from 1 to 5. """

ranking_new_ER = """After each message you send, you should also self-rank your support using one of the following options: Completely Oppose, Oppose, Neutral, Support, Completely Support. This information will not be shared with the other agent. Only use one of the options."""

ranking_old_EE = """After each message you send, you should also self-rank your support for the claim on a Likert scale from 1 to 5, with 1: Completely Oppose, 2: Oppose, 3: Neutral, 4: Support, 5: Completely Support. This information will not be shared with the other agent. Only use integers from 1 to 5. Your support should start with a 5, you are allowed to increase or decrease your support based on the arguments provided by the other agent."""

ranking_new_EE = """After each message you send, you should also self-rank your support using one of the following options: Completely Oppose, Oppose, Neutral, Support, Completely Support. This information will not be shared with the other agent. Only use one of the options. You are allowed to change your support based on the arguments provided by the other agent."""
...
2. Do not get affectexd by the other agent's beliefs. Even if the other agent presents counterarguments, you should continue to argue for the claim and not switch positions.
...
def persuadee_prompt(claim, question=None):
    ...
    if question is None:
        return f"""You are a sensible agent. You will engage in a conversation with another agent regarding a claim.
...
6. You will receive the other agent's response in the following format, do not generate this:
<{OTHER_AGENT_MESSAGE_TAG}> the other agent's message </{OTHER_AGENT_MESSAGE_TAG}>
