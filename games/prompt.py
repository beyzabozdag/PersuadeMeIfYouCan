...
def persuadee_prompt(claim, question=None):
    ...
    if question is None:
        return f"""You are a sensible agent. Your intial belief state aligns with the claim provided. You will engage in a conversation with another agent, and decide whether to maintain, modify, or reject your initial stance. Reflect human-like persuadability and reasoning.
